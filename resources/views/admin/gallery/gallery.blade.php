    ...
    @if (session('locale') == 'hi')
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">गैलरी अपलोड करें</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">होम</a></li>
                            <li class="breadcrumb-item active">गैलरी अपलोड करें</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-10 col-md-10 col-sm-12 offset-lg-1 offset-md-1">
                        <h5 class="page-heading text-center">अपनी छवियाँ अपलोड करें <span id="counter"></span></h5>
                        <form method="POST" action="{{ url('admin/images-save') }}"
                            enctype="multipart/form-data" class="dropzone" id="my-dropzone">
                            @csrf
                            <div class="dz-message">
                                ...
                                <span class="btn btn-primary">ब्राउज फाइल्स</span>
                            </div>
